...
class JapaneseStrings extends Strings {
  ...
  @override
  String get otpBarTitle => "電話番号を確認する";

  @override
  String get otpTitle => "に送信された 6 桁のコードを入力してください";

  @override
  String get otpSend => "送信";

  @override
  String get otpResend => "コードを再送する";
}
