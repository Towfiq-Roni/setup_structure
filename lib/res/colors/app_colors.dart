...
class AppColors implements BaseColors {
  ...
  @override
  Color get borderColor => const Color(0xFF48A5A7).withOpacity(0.5);

  @override
  Color get primaryColor => const Color(0xFF48A5A7);

  @override
  Color get primaryErrorColor => const Color(0xFFD32F2F);

  @override
  Color get primaryTextColor => const Color(0xFF1A1A1C).withOpacity(0.87);

  @override
  Color get secondaryColor => const Color(0xFF626264);

  @override
  Color get primaryColorBackground => const Color(0xFFFBF4E2);

  @override
  Color get secondaryColorBorder => const Color(0xFF000000).withOpacity(0.12);
